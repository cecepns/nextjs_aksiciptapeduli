...
import ChildCount from '../component/frontend/child_count'

export async function getServerSideProps(ctx) {

    // const getCampaign = await fetch('https://aksiciptapeduli.org/api/campaign')
    // const getCampaign = await
    // fetch('https://test.aksiciptapeduli.org/api/campaign')
    const getCampaign = await fetch('http://localhost:3000/api/campaign?per_page=6')
                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 gap-4">
                        <div className="text-center md:text-left">
                            ...
                            <p
                                className="py-4 text-gray-500 tracking-wide leading-relaxed md:leading-relaxed">
                                Aksi Cipta Peduli adalah lembaga Filantropi
                                <br/>
                                pengelola donasi kemanusiaan, zakat, infak, sedekah, dan wakaf.
                            </p>
                            <button
